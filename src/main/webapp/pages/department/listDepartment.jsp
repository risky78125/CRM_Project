...
<table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
  <tr>
    ...
    <td width="57%"align="right">
    	<%--添加部门 --%>
       <a href="${pageContext.request.contextPath}/addOrEditDepartment.action">
    ...
    <s:iterator value="departments" var="dept">
        <tr>
            ...
            <td width="7%" align="center">
                <a href="${pageContext.request.contextPath}/addOrEditDepartment.action?deptId=${dept.deptId}"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
            </td>
        </tr>
    </s:iterator>
